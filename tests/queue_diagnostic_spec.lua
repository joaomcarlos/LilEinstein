...
local tests = {
    {"uses lab entity productivity bonus (includes force bonus) without double-counting", function()
        ...
        -- In the real Factorio API, lab_entity.productivity_bonus already
        -- includes force.laboratory_productivity_bonus. The stub simulates
        -- this by setting productivity_bonus = 1 (force bonus included).
        local lab_entity = make_lab(300, {productivity_bonus = 1, research_speed = 1})
