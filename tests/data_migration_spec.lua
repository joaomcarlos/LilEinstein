...
local tests = {
    {"registers data-stage styles, inputs, signals, sprites, and settings", function()
        ...
        t.assert_equal(styles.lil_einstein_main_left_frame.width, 558)
        t.assert_equal(styles.lil_einstein_upcoming_scroll_pane.width, 525)
        t.assert_equal(styles.lil_einstein_row_flow.height, 74)
        t.assert_equal(styles.lil_einstein_upcoming_row_frame.width, 525)
        t.assert_equal(styles.lil_einstein_upcoming_row_frame.height, 74)
        t.assert_equal(styles.lil_einstein_upcoming_icon_stack.width, 74)
        t.assert_equal(styles.lil_einstein_upcoming_icon_stack.height, 74)
        t.assert_equal(styles.lil_einstein_upcoming_tech_icon_button.width, 74)
        t.assert_equal(styles.lil_einstein_upcoming_tech_icon_button.height, 74)
        t.assert_equal(styles.lil_einstein_drag_handle.height, 74)
        t.assert_equal(styles.lil_einstein_throughput_details_panel.type, "frame_style")
        ...
        t.assert_equal(styles.lil_einstein_research_health_details_button.width, 56)
        t.assert_equal(styles.lil_einstein_research_health_reason.width, 124)
        t.assert_equal(styles.lil_einstein_research_health_copy_button.parent, "lil_einstein_icon_button")
        t.assert_equal(styles.lil_einstein_research_health_copy_button.width, 24)
        t.assert_equal(styles.lil_einstein_research_status_bar.width, 1585)
        t.assert_equal(styles.lil_einstein_research_status_bar.top_margin, 10)
