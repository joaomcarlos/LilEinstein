...
tests[#tests + 1] = {"sanitizes settings and rejects invalid values", function()
    ...
    t.assert_equal(policy.get_setting(1, "forecast_seconds"), 300)
    t.assert_false(policy.set_setting(1, "strategy", "not-a-strategy"))
    t.assert_false(policy.set_setting(1, "missing", true))
end}

tests[#tests + 1] = {"min_switch_seconds default, min floor, and 30s cap", function()
    reset_policy()
    t.assert_equal(policy.get_setting(1, "min_switch_seconds"), 20)
    t.assert_true(policy.set_setting(1, "min_switch_seconds", 3))
    t.assert_equal(policy.get_setting(1, "min_switch_seconds"), 5)
    t.assert_true(policy.set_setting(1, "min_switch_seconds", 30))
    t.assert_equal(policy.get_setting(1, "min_switch_seconds"), 30)
    t.assert_true(policy.set_setting(1, "min_switch_seconds", 100))
    t.assert_equal(policy.get_setting(1, "min_switch_seconds"), 30)
    t.assert_true(policy.set_setting(1, "min_switch_seconds", nil))
    t.assert_equal(policy.get_setting(1, "min_switch_seconds"), 5)
    t.assert_true(policy.set_setting(1, "min_switch_seconds", "not-a-number"))
    t.assert_equal(policy.get_setting(1, "min_switch_seconds"), 5)
end}

tests[#tests + 1] = {"forecast_seconds default, zero floor, and 300s cap", function()
    reset_policy()
    t.assert_equal(policy.get_setting(1, "forecast_seconds"), 120)
    t.assert_true(policy.set_setting(1, "forecast_seconds", 0))
    t.assert_equal(policy.get_setting(1, "forecast_seconds"), 0)
    t.assert_true(policy.set_setting(1, "forecast_seconds", 300))
    t.assert_equal(policy.get_setting(1, "forecast_seconds"), 300)
    t.assert_true(policy.set_setting(1, "forecast_seconds", 99999))
    t.assert_equal(policy.get_setting(1, "forecast_seconds"), 300)
    t.assert_true(policy.set_setting(1, "forecast_seconds", nil))
    t.assert_equal(policy.get_setting(1, "forecast_seconds"), 0)
    t.assert_true(policy.set_setting(1, "forecast_seconds", "bad"))
    t.assert_equal(policy.get_setting(1, "forecast_seconds"), 0)
end}

tests[#tests + 1] = {"plan_horizon_minutes default, 1..300 bounds, and nil/invalid", function()
    reset_policy()
    t.assert_equal(policy.get_setting(1, "plan_horizon_minutes"), 30)
    t.assert_true(policy.set_setting(1, "plan_horizon_minutes", 1))
    t.assert_equal(policy.get_setting(1, "plan_horizon_minutes"), 1)
    t.assert_true(policy.set_setting(1, "plan_horizon_minutes", 300))
    t.assert_equal(policy.get_setting(1, "plan_horizon_minutes"), 300)
    t.assert_true(policy.set_setting(1, "plan_horizon_minutes", 99999))
    t.assert_equal(policy.get_setting(1, "plan_horizon_minutes"), 300)
    t.assert_true(policy.set_setting(1, "plan_horizon_minutes", 0))
    t.assert_equal(policy.get_setting(1, "plan_horizon_minutes"), 1)
    t.assert_true(policy.set_setting(1, "plan_horizon_minutes", nil))
    t.assert_equal(policy.get_setting(1, "plan_horizon_minutes"), 1)
    t.assert_true(policy.set_setting(1, "plan_horizon_minutes", "not-a-number"))
    t.assert_equal(policy.get_setting(1, "plan_horizon_minutes"), 1)
    t.assert_true(policy.set_setting(1, "plan_horizon_minutes", 45.9))
    t.assert_equal(policy.get_setting(1, "plan_horizon_minutes"), 45)
end}
