...
- Health snapshots finish the technology captured at job start; display consumers reject stale technology snapshots and request the current technology on the next tick, so research rotation cannot repeatedly starve a bounded job
